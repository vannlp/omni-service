...
<table border="1"  width="100%" style="font-size: 8px">
    <tbody>
        ...
        <tr style="text-align: left;">
            <td width="28%" ><b>·</b>&nbsp;NPP: <b>{{ $data['NPP'] }}</b><br><b>·</b>&nbsp;SĐT: <b>{{ $data['npp_phone'] }}</b><br><b>·</b>&nbsp;Khách hàng: <b> {{ date('d/m/Y H:i', strtotime($data['print_date'])) }}</b><br></td>
{{--                    <li>NPP: {{ $data['NPP'] }}</li><li>SĐT: <b>{{ $data['npp_phone'] }}</b></li><li>Ngày in phiếu: {{ date('d/m/Y H:i', strtotime($data['print_date'])) }}</li></ul></td>--}}
            <td width="72%"><b>·</b>&nbsp;Khách hàng: <b>{{ $value['customer_name'] }}</b> - SĐT: <b>{{ $value['shipping_address_phone'] }}</b><br><b>·</b>&nbsp;Địa chỉ giao hàng: <b>{{ $value['shipping_address'] }}</b><br><b>·</b>&nbsp;Mã đơn hàng: <b>{{ $data['SPGH'] }}</b><br><b>·</b>&nbsp;Ngày đặt hàng: <b>{{ $value['create'] }}</b><br><b>·</b>&nbsp;Ghi chú đơn hàng: <b>{{$value['description'] ?? ""}}</b></td>
{{--                <ul>--}}
