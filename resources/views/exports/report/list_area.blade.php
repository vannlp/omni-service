...
<table>
     <thead>
          <tr>
               <th colspan="12" style="text-align: center;font-weight: bold;">Danh sách ngành nghề</th>
          </tr>
          <tr>
          ...
          <tr class="header-table">
               <th colspan="2" style="text-align: left; font-weight: bold;">Mã ngành nghề</th>
               <th colspan="2" style="text-align: left; font-weight: bold;">Tên ngành nghề</th>
