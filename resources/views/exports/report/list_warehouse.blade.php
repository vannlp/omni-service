...
<table>
     <thead>
          <tr>
               <th colspan="12" style="text-align: center;font-weight: bold;">Danh sách kho</th>
          </tr>
          <tr>
          ...
          <tr class="header-table">
               ...
               <th colspan="2" style="text-align: left; font-weight: bold;">Địa chỉ kho</th>
     ...
     <tbody>
          ...
          <tr>
               ...
               <td colspan="2" style="border: 1px solid #777; text-align: right">{{!empty($item['address']) ? $item['address'] : ''}}</td>
