                        ...
                        <table class="email-body_inner" align="left" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="content-cell">
                                    <h1>Xin chào {{$order->store->name ?? null}},</h1>
                                    <p>Đơn hàng mới của bạn vừa được đặt:
                                        <strong>#{{$order->code}}</strong></p>
                                    <!-- Action -->
                                    {{--                                    <p>&nbsp;</p>--}}
                                    <p>Thông tin:</p>
                                    <p>Mã đơn hàng: <strong>{{$order->code}}</strong></p>
                                    <p>Khách
                                        hàng: <strong>{{$order->customer->name ?? null}}</strong></p>
                                    ...
                                    <table class="body-action" align="center" width="100%"
                                        ...
                                        <tr>
                                            ...
                                            <td style="color: red;text-align: right">{{number_format($order->total_price)}}
                                                đ&nbsp;
                                            </td>
                                        </tr>
                                        </tbody>
