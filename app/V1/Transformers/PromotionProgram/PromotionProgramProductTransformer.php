...
class PromotionProgramProductTransformer extends TransformerAbstract
{
    /**
     ...
     */
    public function __construct($promotionPrograms, $promtion)
    {
...
//                    $special_percentage = round(($promotionPrice / $price) * 100);
            ...
            $start = !empty($this->promtion[0]['start_date']) ? $this->promtion[0]['start_date'] : null;
            $end   = !empty($this->promtion[0]['end_date']) ? $this->promtion[0]['end_date'] : null;
