...
class UnitImportController
{
    ...
    public function import(Request $request)
    {
        ...
        $countRow = 0;
        $empty    = true;
        $fileName = "Import-Unit_By-" . (TM::getCurrentUserId()) . "_(" . date('Y_m_d-H_i_s', time()) . ")";
        ...
        try {
            $dataCheck = [
                'code' => [
                    ...
                    'model'  => new UnitModel(),
                    'where'  => ' `company_id` = ' . $company_id . ' and `store_id` = ' . $store_id. ' and `deleted` = ' . $deleted,
                ],
            ];
