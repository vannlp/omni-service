...
class OrderByPromotionExport extends BaseExport implements FromView, WithColumnFormatting, WithEvents, WithStyles, WithColumnWidths, ShouldAutoSize
{
     protected $_name;
     protected $_header;
     protected $_from;
      ...
      * @param null $to
      */
     public function __construct(string $name, array $header, $from = null, $to = null, $time)
     {
          $this->_name = $name;
          $this->_header = $header;
          $this->_time = $time;
